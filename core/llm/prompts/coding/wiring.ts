...
import { SYSTEM_BASE, SYSTEM_WORKSPACE, SKILLS, SECRETS, CREDENTIALS_FACT, DATABASE_FACT, DATABASE_SHARED_FACT } from './coding.js';
...
export interface WorkspaceFacts {
  ...
  database?: boolean;
  /** agent_database_shared: the project's code can reach that database too
