...
export const DEFAULTS = {
  ...
  assistant_history_limit: null as number | null,
...
export const DESCRIPTIONS: Record<ConfigKey, string> = {
  ...
  assistant_history_limit: 'Messages the Assistant keeps before older ones are summarized into context (compaction). Empty = 100. The full record stays on disk.',
...
export const META: Record<ConfigKey, ConfigMeta> = {
  ...
  assistant_history_limit: { type: 'number', label: 'assistant history limit', group: 'voice' },
