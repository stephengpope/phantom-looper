...
- The window opens with ZERO sessions; boot is App's own effect through the
  ...
  (`lastWorkspaceId` ignores looper-run sessions and deleted workspaces).
